...
A REST API server for controlling and monitoring your Anker PowerHouse 767 (F2000) power station via Bluetooth Low Energy.
...
Prometheus metrics exposed at `/metrics`. Great for Grafana dashboards!
